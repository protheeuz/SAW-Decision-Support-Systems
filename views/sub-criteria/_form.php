...
<div class="sub-criteria-form">
    ...
    <?= $form->field($model, 'id_criteria')->dropDownList($criteriaList, ['prompt' => 'Select Criteria']) ?>
    ...
    <?php elseif (Yii::$app->user->identity->role == 'Manager PMO' || Yii::$app->user->identity->role == 'Project Director'): ?>
        <?= $form->field($model, 'id')->dropDownList($existingSubCriteriaList, ['prompt' => 'Select Sub-Criteria']) ?>
